...
norsk={
    ...
    1002: "Tegn-kodingen '%s' er ikke střttet",
    1003: "Denne navnerom-syntaksen er foreldet",
    1005: "Tegn nummer '%d' i tegn-referansen er ikke střttet",
    ...
    1901: "Navnerommets URI kan ikke vćre tomt",
    ...
    2010: "Pĺkrevd attributt '%s' mangler",
    ...
    2014: "ID-attributter kan ikke vćre #FIXED eller ha standard-verdier",
    2015: "xml:space mĺ deklareres som en oppramstype",
    2016: "xml:space mĺ ha verdiene 'default' og 'preserve'",
    2017: "'%s' er ikke en gyldig verdi for '%s'-attributtet",
    2018: "Verdien til '%s'-attributtet mĺ vćre et gyldig navn",
    ...
    # --- Well-formedness errors: 3000-3999
    # From xmlutils
    3000: "Kunne ikke ĺpne '%s'",
    3001: "For tidlig slutt pĺ entiteten",
    ...
    3007: "Tekst-deklarasjonen mĺ stĺ fřrst i entiteten",
    3008: "XML-deklarasjonen mĺ stĺ fřrst i dokumentet",
    3009: "Flere tekst-deklarasjoner i samme entitet",
    3010: "Flere tekst-deklarasjoner i samme dokument",
    3011: "XML-versjonen mangler pĺ XML-deklarasjonen",
    3012: "'Standalone'-deklarasjon pĺ tekst-deklarasjon ikke tillatt",
    ...
    3024: "Elementet '%s' lukket, men ikke ĺpent",
    ...
    3033: "Dokument-type-deklarasjon kun tillatt fřr rot-elementet",
    ...
    3046: "Denne XML-versjonen er ikke střttet",

    # From xmlproc.DTDParser
    3035: "Parameter-entiteter kan ikke vćre uparserte",
    ...
    5001: "Pĺkrevd XCatalog-attributt %s pĺ %s mangler.",
     
    # --- SOCatalog errors: 5100-5199
    5100: "Ugyldig eller ikke střttet konstruksjon: %s.",
    }
